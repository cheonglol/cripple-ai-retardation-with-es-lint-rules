...
const ENV_VARS: EnvVar[] = [
  ...
  { name: EnvVarKeys.TELEGRAM_BOT_TOKEN, description: "Telegram bot token", required: true, },
  { name: EnvVarKeys.WHATSAPP_VERIFY_TOKEN, description: "WhatsApp verification token", required: true, },
  { name: EnvVarKeys.WHATSAPP_APP_SECRET, description: "WhatsApp app secret", required: true, },
];
